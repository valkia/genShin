...
<script>
    import {displayedTag} from "utils/utils.js";
    ...
    export default {
        ...
        created: function () {
            ...
            const myArtifact = this.item
            console.log(myArtifact.tag1)
            this.mainDisplayTag = displayedTag(Object.entries(myArtifact.tag1)[0][0], Object.entries(myArtifact.tag1)[0][1]);
            let secTags = [];
            for (let tag of Object.entries(myArtifact.tag2)) {
                secTags.push(displayedTag(tag[0], tag[1]));
            }
